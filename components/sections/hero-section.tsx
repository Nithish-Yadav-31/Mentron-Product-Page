...
const HeroSection = () => {
  ...
  const heroBackgroundFill = theme === 'dark' ? 'hsl(220 25% 8%)' : 'hsl(0 0% 100%)';
    ...
    <section className="relative w-full py-12 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="container px-4 md:px-6 mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 lg:mb-16">
          <Button asChild className={`bg-primary hover:bg-primary/90 font-medium px-6 py-3 rounded-md transition-shadow duration-300 hover:shadow-[0_0_16px_4px_rgba(0,215,255,0.6)] ${theme === 'dark' ? 'text-white' : 'text-primary-foreground'}`}>
