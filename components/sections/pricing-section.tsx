...
//                   <span className="text-4xl xs:text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">$34.99</span>
//                   <span className="text-gray-600 dark:text-gray-400 text-sm xs:text-xs sm:text-sm">/4 months</span>
//                 </div>
//                 <p className="text-lg xs:text-base sm:text-lg text-blue-600 dark:text-blue-400 font-semibold">Only $8.74/month</p>
...
//                     <span className="font-semibold text-sm xs:text-xs sm:text-sm">Save 55% quarterly (equal to $45)!</span>
//                   </div>
//                   <p className="text-sm xs:text-xs mt-1">*Billed $34.99 upfront for 4 months</p>
//                 </div>
//               </div>
//             </div>
