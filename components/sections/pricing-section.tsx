    ...
    <section className="w-full py-20 md:py-32 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 dark:from-black dark:via-gray-950 dark:to-blue-950/30 overflow-hidden">
      <div className="container px-4 md:px-6 mx-auto relative">
        ...
        <div className="flex justify-center mb-12 relative z-10">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md p-1 rounded-xl flex items-center border border-gray-200 dark:border-gray-700 shadow-lg">
            ...
            >
              ...
              Yearly Billing
              <span className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs px-2 py-1 rounded-full">Most Popular! Save 37.5%</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto relative z-10">
          {/* Monthly Plan */}
          <div
            className={`relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl border-2 p-8 shadow-2xl transition-all duration-300 ${
              !isYearly ? "border-blue-600 scale-105 shadow-blue-500/20" : "border-gray-200 dark:border-gray-700"
            }`}
          >
            <div className="mb-6">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 text-sm font-medium mb-4">
                Monthly
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Mentron Monthly</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-6">Flexibility to start, adapt, and scale.</p>
              <div className="mb-6">
                <span className="text-4xl font-bold text-gray-900 dark:text-white">$20</span>
                <span className="text-gray-600 dark:text-gray-400">/month</span>
                <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">Billed monthly</p>
              </div>
            </div>
            ...
            <Button asChild className="w-full bg-gray-900 dark:bg-white text-white dark:text-gray-900 py-6 text-lg rounded-xl font-semibold hover:bg-gray-800 dark:hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl">
              <Link href="/institutional-demo">
                Get Started Monthly
              </Link>
            </Button>
            <p className="text-center text-sm text-gray-500 dark:text-gray-500 mt-3">Begin your transformation.</p>
          </div>
          ...
          >
            {isYearly && (
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 shadow-lg">
            ...
            <div className="mb-6">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm font-medium mb-4 border border-blue-200 dark:border-blue-800">
                Annual
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Mentron Annual</h3>
              ...
              <div className="mb-6">
                ...
                <p className="text-lg text-blue-600 dark:text-blue-400 font-semibold">Only $12.50/month</p>
                <p className="text-sm text-gray-500 dark:text-gray-500">(billed annually)</p>
                <div className="bg-green-50 dark:bg-green-950/50 text-green-700 dark:text-green-400 px-4 py-3 rounded-xl mt-3 border border-green-200 dark:border-green-800">
                  <div className="flex items-center gap-2">
                    <Rocket className="w-4 h-4" />
                    <span className="font-semibold">Save 37.5% annually (equal to $90)!</span>
                  </div>
                  <p className="text-sm mt-1">*Billed $150 upfront for the year</p>
                </div>
              </div>
            </div>
            ...
            <Button asChild className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-6 text-lg rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl">
              <Link href="/institutional-demo">
